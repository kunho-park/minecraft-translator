...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-[var(--border-primary)] bg-[var(--bg-secondary)]/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Links */}
          <div className="space-y-4">
            <h3 className="font-semibold text-[var(--text-primary)]">Links</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-[var(--bg-card)] flex items-center justify-center text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-card-hover)] transition-all"
              >
                <Github className="w-5 h-5" />
              </a>
              <a
                href="https://discord.gg/UBkvjNgvYX"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-[var(--bg-card)] flex items-center justify-center text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-card-hover)] transition-all"
              >
